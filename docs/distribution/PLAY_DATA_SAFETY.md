...
StudyShield uses Android Accessibility only for foreground package-name detection and an accessibility overlay. It does not read Accessibility node content, screenshots, typed text, passwords, messages, contacts, location, browser history, or full media-library contents.
